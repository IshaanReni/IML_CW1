...
def plot_edges(nodes, order_list, depth_dist, label_Width, label_Height):
    ...
    for n in nodes:
        if n != None:
            ...
            for n2 in nodes:            # finding the children of the parent node by calculating expected coords and finding them in the nodes array
